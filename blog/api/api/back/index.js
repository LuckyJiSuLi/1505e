...
router.post("/add_class_one", function(req, res, next) {
    ...
    var sqlinsert1 = `insert into one_class(id,enname,cnname) values('${req.body.idone}','${req.body.enname_one}','${req.body.cnname_one}')`
    var sqlinsert2 = `insert into one_class(id,parent_id,enname,cnname,article_num) values('${req.body.idtwo}','${req.body.idone}','${req.body.enname_two}','${req.body.cnname_two}',0)`
    ...
    testone_enname(req, res, next, sqltest1).then(function(data) {
        ...
        testone_enname(req, res, next, sqltest2)
